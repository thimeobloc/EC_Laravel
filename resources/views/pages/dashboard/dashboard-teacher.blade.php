                                ...
                                <table id="students-table" class="table table-border table-with-modal" data-datatable-table="true">
                                    ...
                                    @foreach($students as $student)
                                        <tr>
                                            ...
                                            <td>{{ $student->birthdate ?? 'Information manquante'}}</td> <!-- Birthdate, fallback if missing -->
...
@include('pages.students.student-modal') <!-- Include modal for adding/editing students -->
